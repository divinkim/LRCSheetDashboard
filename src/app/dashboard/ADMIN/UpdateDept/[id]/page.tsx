...
import UpdateDeptHookModal from "../hook";
...
export default function UpdateDept () {
     ...
     const {dynamicArrayData, inputs, setInputs, handleSubmit, isLoading} = UpdateDeptHookModal()
                         ...
                         <div className="text-gray-700 space-y-4 md:space-y-0 w-full items-center">
                             <div className="flex justify-between flex-wrap">
                                 <h1 className="text-gray-700 text-[20pn] mb-3 font-bold dark:text-gray-300  ">
                                     {element.addDepartmentUser.titleUpdate}
                                 </h1>
                                 <p className="text-blue-700 dark:text-blue-600" >
                                     Dashboard/ADMIN/Modifier un départemnt
                                 </p>
                             </div>
                                                     ...
                                                     <select value={inputs[e.alias] ?? ""} onChange={(u) => {
                                                        ...
                                                        </option>
                                                        {
                                                            e.dynamicOptions?.status && (
                                                                dynamicArrayData.find(item => item.alias === e.alias)?.
