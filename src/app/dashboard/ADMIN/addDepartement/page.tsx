...
export default function AddDepartment() {
    const { isLoading, DynamicArrayDatas, dynamicArrayDatasCloned, inputs, setInputs, handleSubmit } = AddDepartmentHookUser()
                            ...
                            <div className="text-gray-700 space-y-4 md:space-y-0 w-full items-center">
                                <div className="flex justify-between flex-wrap">
                                    ...
                                    <p className="text-blue-700 dark:text-blue-600" >
                                        Dashboard/ADMIN/Ajouter un département
                                    </p>
                                </div>

                                <hr className="bg-gray-400" />
                                <div className="flex flex-wrap py-4 items-center  lg:space-x-4">
                                    {
                                        element.addDepartmentUser.navigationDeptLinks.map((element, index) => (
                                            <Link href={element.href} className=
                                                "bg-blue-800 hover:bg-blue-900 ease duration-500 px-4 py-3">
                    ...
                    <div className='dark:border mt-8 w-full font-semibold md:w-3/4 h-auto border-gray-400 dark:border-gray-300 
                                                ...
                                                !e.selectedInput && !e.textarea ?
                                                    <input value={inputs[e.alias] ?? ""} onChange={async (v) => {
                                                        ...
                                                        if (e.type == "files") {
                                                            ...
                                                            if (response.status) {
                                                                ...
                                                                localStorage.setItem("inputMemoryOfAddDepartment", JSON.stringify(fieldValue))
                                                            }
                                                            return
                                                        }
                                                        fieldValue = {
                                                      ...
                                                      border-gray-400 dark:border-gray-300  placeholder-gray-700 dark:placeholder-gray-300 font-semibold dark:text-gray-300 text-gray-700"
                                                    ...
                                                    e.textarea && !e.selectedInput ?
                                                        <textarea placeholder={e.placeholder ?? ""} value={inputs[e.alias] ?? ""} onChange={(u) => {
                                                         ...
                                                         bg-transparent border border-gray-400 placeholder-gray-700 dark:border-gray-300  dark:placeholder-gray-300 font-semibold
                                                        ...
                                                        <select value={inputs[e.alias] ?? ""} onChange={(u) => {
                                                            ...
                                                            border border-gray-400 dark:border-gray-300 dark:bg-gray-900 font-semibold placeholder-gray-700 dark:placeholder-gray-300 dark:text-gray-300 text-gray-700" >
                                                            <option selected>
                                                                {e.placeholder}
                                                            </option>
                                                            {
                        ...
                        <div className="flex w-full justify-end ">
                            <button type="button" onClick={() => {
                                ...
                                <p className="">
                                    {isLoading ? <ClipLoader size={16} color="#fff" /> : "Exécuter"}
                                </p>
