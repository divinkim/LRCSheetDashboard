...
export default function GetDistricts() {
    ...
    const maxPage = Math.ceil(districtsArrayCloned.length / limit);
    return (
        <div>
            <Header />
                ...
                >
                    ...
                    <div className="px-4">
                        ...
                        <FontAwesomeIcon icon={faSearch} className="absolute text-gray-400 right-3 top-[38px]" />
                            ...
                            {
                                tablesModal.map((e) => (
                                    e.districtsList.links.map((item) => (
                                        <Link href="" onClick={() => {
                        ...
                        <table className="border w-full mx-auto">
                            <thead>
                                <tr className="bg-gray-800 dark:bg-transparent ">
                                    {
                                        tablesModal.map((e) => (
                                            e.districtsList.table.titles.map((item) => (
                            ...
                            <tbody className="w-full">

                                {
                                    ...
                                    districtsArrayCloned.length > 0 ? districtsArrayCloned.slice(start, start + limit).map((u) => (
                                        <tr className="">
