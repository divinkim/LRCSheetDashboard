        ...
        <div>
            ...
            <div className="flex justify-center w-full mx-auto">
                ...
                >
                    ...
                    }} className={!isVisibleFormQuarter ? "hidden" : "absolute cursor-pointer text-white top-8 right-8 z-30"}>
                        <FontAwesomeIcon className="text-[20px]" icon={faTimes} />
                    </div>
                    <AddQuarter isVisibleFormQuarter={isVisibleFormQuarter} />
                    <div className="px-4">
                        {
                            tablesModal.map((e) => (
                    ...
                    </div> */}
                            {
                                tablesModal.map((e) => (
                                    e.quartersList.links.map((item) => (
                                        <Link href="" onClick={() => {
                                            if (item.title === "Ajouter un quartier") {
                                                setIsVisibleFormAddQuarter(true)
                                            }
