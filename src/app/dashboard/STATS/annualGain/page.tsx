            ...
            <div className="flex min-w-0">
                <div className="mx-4 mt-6 my-4 w-full min-w-0">
                    <div className="flex justify-between items-center mb-5">
                        <h1 className="text-[22px] font-bold text-gray-700 dark:text-gray-300">Statistiques du gain annuel ({new Date().getFullYear()})</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 min-w-0">
                        {/* PieChart mensuel */}
                        <div className="p-4 shadow-xl dark:text-gray-300 bg-white rounded-xl  dark:shadow-none  dark:bg-gray-800/50">
                        ...
                        {/* LineChart mensuel */}
                        <div className="p-4 shadow-xl dark:shadow-none dark:bg-gray-800/50 dark:text-gray-300  bg-white rounded-xl">
                        ...
                        <div className="p-4 shadow-xl bg-white rounded-xl dark:text-gray-300  dark:shadow-none dark:bg-gray-800/50">
